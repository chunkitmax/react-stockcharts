...
import SpeedResistanceLine from "../components/SpeedResistanceLine";
import HoverTextNearMouse from "../components/HoverTextNearMouse";

class EachSpeedResistanceLine extends Component {
	constructor(props) {
		super(props);
		...
		this.handleSpeedResistanceLineDrag = this.handleSpeedResistanceLineDrag.bind(this);
	...
	handleSpeedResistanceLineDrag(moreProps) {
		...
		return (
			<g>
				<SpeedResistanceLine
					...
					onDragStart={this.handleDragStart}
					onDrag={this.handleSpeedResistanceLineDrag}
					onDragComplete={onDragComplete}
				/>
				{line1Edge}
				<HoverTextNearMouse
...
EachSpeedResistanceLine.propTypes = {
...
EachSpeedResistanceLine.defaultProps = {
...
export default EachSpeedResistanceLine;